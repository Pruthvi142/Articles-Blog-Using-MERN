          ...
          Swal.fire({
            ...
            .then((result) => {
              if (result.value) {
                ...
                axios
                  .get("http://localhost:7000/admin/account", {
                    headers: {
...
export const startAdminDeleteUser = (id) => {
  return (dispatch) => {
    axios
      .delete(`http://localhost:7000/admin/users/delete/${id}`, {
...
export const startAdminCommentDelete = (id) => {
  return (dispatch) => {
    {
      axios
        .delete(`http://localhost:7000/article/comment/delete/${id}`, {
          headers: { Authorization: localStorage.getItem("authToken") },
        })
        .then((response) => {
          const data = response.data;
...
export const startAdminDeleteArticle = (id) => {
  return (dispatch) => {
    axios
      .delete(`http://localhost:7000/admin/article/delete/${id}`, {
        headers: { Authorization: localStorage.getItem("authToken") },
      })
      .then((response) => {
