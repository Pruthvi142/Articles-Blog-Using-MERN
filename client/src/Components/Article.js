    ...
    return (
      <div style={{ marginLeft: "20px" }}>
        ...
        {this.props.article
          ...
          .filter((art) => art.title.includes(this.state.search))
          .map((ele) => {
              ...
              >
                <div className="card-body">
                      ...
                      <div>
                        {profile ? (
                          <img
                            ...
                            src={`http://localhost:7000/${profile}`}
                            width="40"
                            height="40"
                          />
                        ) : (
                  ...
                  <small class="text-muted">
                    {" "}
                    posted on{moment(ele.createdAt).fromNow()}
                  </small>

                  {Object.keys(this.props.user).length !== 0 ? (
                    <div>
                      {this.props.user._id == likeUser ? (
                        <div>
                          {" "}
                          you liked{ele.likes.length}{" "}
                          <button
                            type="button"
                            onClick={() => {
                              this.handleDislike(ele._id);
                            }}
                          >
                            {" "}
                            <h6>
                          ...
                          <button
                            ...
                            class="btn btn-outline-secondary"
                            onClick={() => {
                              this.showComent(ele._id);
                            }}
                          >
                            <BsFillChatDotsFill />
                            view all{ele.comments.length}comments
                          </button>{" "}
                        </div>
                      ) : (
                        <div>
        ...
        {this.state.count < this.props.article?.length != 0 && (
          <button onClick={this.handleView} className="btn btn-outline-success">
            {" "}
            view more
          </button>
        )}
